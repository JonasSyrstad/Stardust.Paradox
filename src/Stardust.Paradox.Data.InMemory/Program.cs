...
using Stardust.Paradox.Data.InMemory.Examples;
...
namespace Stardust.Paradox.Data.InMemory
{
    ...
    internal class Program
    {
        ...
        private static async Task DemoAdvancedFeatures()
        {
            ...
            Console.WriteLine($"   High priority project budget under Alice: ${result1.SafeFirst()}");
...
// Comment out or remove the Program class if you don't want a console application