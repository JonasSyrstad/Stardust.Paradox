...
namespace Stardust.Paradox.Data
{
    public struct Pair<T1, T2> where T1:class where T2 : class
    {
        ...
        {
            if (!(obj is Pair<T1, T2>)&& !(obj is Pair<T2, T1>))
            {
                return false;
            }
        ...
        {
            return EqualityComparer<T1>.Default.Equals(Item1, other.Item2) && EqualityComparer<T2>.Default.Equals(Item2, other.Item1);
        }
